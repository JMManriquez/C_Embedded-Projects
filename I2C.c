...
{
   SDA_PIN = 1;
   SDA_DIR = 1;						//Set to input mode
   __delay_us(2);                   // bring SDA to high impedance
}
...
{
   SCL_PIN = 1;
   SCL_DIR = 1;						//Set to input mode
   __delay_us(10);                  // bring SCL to high impedance
}
